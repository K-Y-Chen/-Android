...
//        String id="111";
    ...
    public static String getAddress(Context context) {
        return SharedPreferencesUtil.getData(context, "user", "address", "");

    }

    public static String getAddressDetail(Context context) {
        return SharedPreferencesUtil.getData(context, "user", "address_detail", "");
    ...
    public static String getNum(Context context) {
        return SharedPreferencesUtil.getData(context, "user", "num", "");
