...
import com.app.shop.mylibrary.widgts.WarpLinearLayout;
...
public class TimePickerView extends BasePickerView implements View.OnClickListener, WheelTime.RollDay {
    ...
    private Drawable Drawable_Background_Title;//标题背景颜色
    ...
    private boolean ycyclic, mcyclic, dcyclic;//是否循环
    ...
    public static class Builder {
        ...
        private boolean ycyclic = false;//是否循环
        private boolean mcyclic = false;//是否循环
        private boolean dcyclic = false;//是否循环
